...
export const ADMIN_EMAIL = 'enzovallet@googlemail.com' // ← change this
...
export const RIOT_REGION   = 'https://europe.api.riotgames.com'

// Starting ZouletteCoins when admin grants manually
